...
run_sweep "tac" "tabnet"         "tac_gauss_rank"                "features_tac_TabNet_rough"      
run_sweep "tac" "gandalf"        "tac_gauss_rank"                "features_tac_DeepTabular_rough" 
run_sweep "tac" "tcn"            "tac_vol_scaled_residual" "features_tac_TimeSeries_rough"  
run_sweep "str" "lgbm"           "str_gauss_rank"                "features_str_LGBM_rough"        
...
run_sweep "tac" "ft_transformer" "tac_gauss_rank"                "features_tac_DeepTabular_rough" 
